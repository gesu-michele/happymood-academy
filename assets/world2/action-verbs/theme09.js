(() => {
  ...
  const CFG = Object.assign({
    forceTeacher: false,
    assetRoot: '../../assets/world2/action-verbs/words/',
    audioRoot: '../../assets/world2/action-verbs/audio/',
  ...
  const THEME_ID = 'action-verbs';
  const THEME_KEY = 'lexiconia.theme09.actionVerbs.v1';
  ...
  const VERB_WORDS = ["Climb", "Crawl", "Kick", "Hit", "Lift", "Drop", "Hold", "Touch", "Point", "Turn", "Bend", "Stretch", "Shake", "Wave", "Clap", "Knock", "Cut", "Fold", "Break", "Fix", "Wash", "Clean", "Cook", "Pour", "Fill", "Empty", "Tie", "Untie", "Hide", "Find"];
  const PREVIOUS_VERB_WORDS = ["Eat", "Drink", "Sleep", "Walk", "Run", "Jump", "Sit", "Stand", "Read", "Write", "Speak", "Listen", "Look", "Watch", "Open", "Close", "Take", "Give", "Put", "Make", "Play", "Draw", "Sing", "Dance", "Swim", "Throw", "Catch", "Push", "Pull", "Carry"];
  const ALL_VERB_WORDS = [...VERB_WORDS,...PREVIOUS_VERB_WORDS];
  const TIER_NAMES = ['FOUNDATION','EXPLORER','CHALLENGER','MASTER'];

  const TARGETS = [
    ["Climb","escalar / subir","01-climb.png","01_climb.png","/klaɪm/","climb","vertical","Move upwards using your hands and feet, steps or a surface.","upward movement"],
    ["Crawl","gatear / arrastrarse","02-crawl.png","02_crawl.png","/krɔːl/","crawl","low-movement","Move slowly with your body close to the ground, often on hands and knees.","low body movement"],
    ["Kick","patear","03-kick.png","03_kick.png","/kɪk/","kick","impact","Strike or send something with your foot.","foot action"],
    ["Hit","golpear","04-hit.png","04_hit.png","/hɪt/","hit","impact","Touch something forcefully with your hand, a tool or another object.","forceful contact"],
    ["Lift","levantar","05-lift.png","05_lift.png","/lɪft/","lift","vertical-object","Move an object upwards from a lower position.","upward object movement"],
    ["Drop","dejar caer","06-drop.png","06_drop.png","/drɒp/","drop","vertical-object","Let something fall from your hand or a higher position.","downward release"],
    ["Hold","sostener","07-hold.png","07_hold.png","/həʊld/","hold","control-object","Keep something in your hand or arms without letting it fall.","continued control"],
    ["Touch","tocar","08-touch.png","08_touch.png","/tʌtʃ/","touch","contact","Put your hand, finger or another part of your body on something.","direct contact"],
    ["Point","señalar","09-point.png","09_point.png","/pɔɪnt/","point","gesture","Direct a finger or object towards a person, place or thing.","directed gesture"],
    ["Turn","girar","10-turn.png","10_turn.png","/tɜːn/","turn","direction","Move or rotate so that you face or point in another direction.","change of direction"],
    ["Bend","doblar / inclinar","11-bend.png","11_bend.png","/bend/","bend","body-shape","Move your body or an object so that it is no longer straight.","curved position"],
    ["Stretch","estirar","12-stretch.png","12_stretch.png","/stretʃ/","stretch","body-shape","Extend your body, arms or legs to make them longer or straighter.","extended position"],
    ["Shake","sacudir","13-shake.png","13_shake.png","/ʃeɪk/","shake","repeated-movement","Move something quickly backwards and forwards or up and down.","repeated movement"],
    ["Wave","saludar con la mano / agitar","14-wave.png","14_wave.png","/weɪv/","wave","gesture","Move your hand from side to side to greet someone or attract attention.","side-to-side greeting"],
    ["Clap","aplaudir","15-clap.png","15_clap.png","/klæp/","clap","sound-action","Bring your hands together repeatedly to make a sound.","hands making sound"],
    ["Knock","tocar / golpear una puerta","16-knock.png","16_knock.png","/nɒk/","knock","sound-action","Hit a door or surface with your hand to make a sound.","signal by impact"],
    ["Cut","cortar","17-cut.png","17_cut.png","/kʌt/","cut","tool-action","Use a sharp tool to divide or open something.","sharp-tool division"],
    ["Fold","doblar","18-fold.png","18_fold.png","/fəʊld/","fold","material-action","Bend paper, cloth or another material so one part lies over another.","layered material"],
    ["Break","romper","19-break.png","19_break.png","/breɪk/","break","change-state","Damage something so it separates or no longer works.","damage or separation"],
    ["Fix","arreglar","20-fix.png","20_fix.png","/fɪks/","fix","change-state","Repair something so it works correctly again.","repair"],
    ["Wash","lavar","21-wash.png","21_wash.png","/wɒʃ/","wash","cleaning","Use water, often with soap, to remove dirt.","water cleaning"],
    ["Clean","limpiar","22-clean.png","22_clean.png","/kliːn/","clean","cleaning","Remove dirt or mess so something becomes clean.","general cleaning"],
    ["Cook","cocinar","23-cook.png","23_cook.png","/kʊk/","cook","food-preparation","Prepare food using heat.","food with heat"],
    ["Pour","verter / servir líquido","24-pour.png","24_pour.png","/pɔː/","pour","liquid-action","Make liquid flow from one container into another place.","flowing liquid"],
    ["Fill","llenar","25-fill.png","25_fill.png","/fɪl/","fill","container-action","Put enough material or liquid into a container to make it full.","making full"],
    ["Empty","vaciar","26-empty.png","26_empty.png","/ˈempti/","emp·ty","container-action","Remove everything from a container so nothing remains inside.","making empty"],
    ["Tie","atar","27-tie.png","27_tie.png","/taɪ/","tie","fastening","Join or fasten things using string, rope or a knot.","fastening with a knot"],
    ["Untie","desatar","28-untie.png","28_untie.png","/ʌnˈtaɪ/","un·tie","fastening","Open or remove a knot so something is no longer tied.","removing a knot"],
    ["Hide","esconder","29-hide.png","29_hide.png","/haɪd/","hide","location","Put yourself or something where it cannot easily be seen or found.","concealment"],
    ["Find","encontrar","30-find.png","30_find.png","/faɪnd/","find","location","Discover or locate someone or something you were looking for.","successful search"]
  ...
  const PREVIOUS_TARGETS = [
    {id:1,word:"Eat",es:"comer",ipa:"",syllables:"eat",group:"previous",clue:"Put food into your mouth and swallow it.",trait:"food",previous:true},
    {id:2,word:"Drink",es:"beber",ipa:"",syllables:"drink",group:"previous",clue:"Take liquid into your mouth and swallow it.",trait:"liquid",previous:true},
    ...
    {id:17,word:"Take",es:"tomar / coger",ipa:"",syllables:"take",group:"previous",clue:"Move something into your hand.",trait:"towards receiver",previous:true},
  ...
  const CATEGORY_LABELS = {"vertical": "Upward body movement", "low-movement": "Low body movement", "impact": "Impact actions", "vertical-object": "Object height and release", "control-object": "Object control", "contact": "Contact actions", "gesture": "Gestures and direction", "direction": "Direction change", "body-shape": "Body and shape change", "repeated-movement": "Repeated motion", "sound-action": "Sound-making actions", "tool-action": "Tool actions", "material-action": "Material handling", "change-state": "Damage and repair", "cleaning": "Cleaning actions", "food-preparation": "Food preparation", "liquid-action": "Liquid movement", "container-action": "Container actions", "fastening": "Fastening actions", "location": "Hide and search actions"};

  const KNOWLEDGE = [
    {fact:"Lift moves an object upwards; drop lets it move downwards.",es:"Lift mueve un objeto hacia arriba; drop permite que baje.",answer:"Lift",icon:"⬆️⬇️"},
    {fact:"Hold keeps an object under control; drop releases it.",es:"Hold mantiene un objeto bajo control; drop lo suelta.",answer:"Hold",icon:"🤲"},
    {fact:"Touch makes direct contact; point only directs attention towards something.",es:"Touch hace contacto directo; point solo dirige la atención hacia algo.",answer:"Point",icon:"👉"},
    {fact:"Bend makes the body or an object less straight; stretch extends it.",es:"Bend dobla el cuerpo o un objeto; stretch lo estira.",answer:"Stretch",icon:"↔️"},
    {fact:"Shake is a quick repeated movement; wave is commonly used as a greeting.",es:"Shake es un movimiento rápido repetido; wave suele usarse como saludo.",answer:"Wave",icon:"👋"},
    {fact:"Clap uses two hands to make a sound; knock usually hits a door or surface.",es:"Clap usa dos manos para hacer sonido; knock suele golpear una puerta o superficie.",answer:"Knock",icon:"👏🚪"},
    {fact:"Cut divides something with a sharp tool; fold bends material without cutting it.",es:"Cut divide algo con una herramienta afilada; fold dobla material sin cortarlo.",answer:"Cut",icon:"✂️"},
    {fact:"Break damages something; fix repairs it.",es:"Break daña algo; fix lo repara.",answer:"Fix",icon:"🛠️"},
    {fact:"Wash normally uses water; clean is the broader action of removing dirt or mess.",es:"Wash normalmente usa agua; clean es la acción más amplia de quitar suciedad o desorden.",answer:"Wash",icon:"🧼"},
    {fact:"Pour describes liquid flowing from one container; fill describes making a container full.",es:"Pour describe un líquido que fluye desde un recipiente; fill describe llenar un recipiente.",answer:"Pour",icon:"🥛"},
    {fact:"Fill and empty are opposite container actions.",es:"Fill y empty son acciones opuestas con recipientes.",answer:"Empty",icon:"🫙"},
    {fact:"Tie makes a knot or fastening; untie opens or removes it.",es:"Tie hace un nudo o sujeción; untie lo abre o elimina.",answer:"Untie",icon:"🪢"},
    {fact:"Hide makes something difficult to see; find means locating it successfully.",es:"Hide hace que algo sea difícil de ver; find significa localizarlo con éxito.",answer:"Find",icon:"🔎"},
    {fact:"Crawl keeps the body close to the ground; climb moves the body upwards.",es:"Crawl mantiene el cuerpo cerca del suelo; climb mueve el cuerpo hacia arriba.",answer:"Climb",icon:"🧗"},
    {fact:"Kick uses the foot; hit can use a hand, tool or another object.",es:"Kick usa el pie; hit puede usar la mano, una herramienta u otro objeto.",answer:"Kick",icon:"⚽"},
    {fact:"Cook prepares food with heat; wash and clean remove dirt.",es:"Cook prepara comida con calor; wash y clean quitan suciedad.",answer:"Cook",icon:"🍳"}
  ];

  const SPELLING_WRONG = {"climb": ["Clime", "Clim", "Clymb"], "crawl": ["Crol", "Craul", "Crawll"], "kick": ["Kic", "Kik", "Kickk"], "hit": ["Hitt", "Het", "Hiit"], "lift": ["Liftt", "Lyft", "Lifft"], "drop": ["Dorp", "Dropp", "Drup"], "hold": ["Hould", "Holld", "Hlod"], "touch": ["Tuch", "Tutch", "Touchh"], "point": ["Piont", "Poynt", "Pointt"], "turn": ["Tern", "Turnn", "Turm"], "bend": ["Bnd", "Bennd", "Bemd"], "stretch": ["Strech", "Stretchh", "Stretc"], "shake": ["Shaik", "Shak", "Shakee"], "wave": ["Waiv", "Wav", "Wavee"], "clap": ["Clapp", "Clappp", "Clup"], "knock": ["Nock", "Knockk", "Knok"], "cut": ["Cutt", "Kutt", "Ctu"], "fold": ["Fould", "Folld", "Flod"], "break": ["Breake", "Braek", "Brek"], "fix": ["Fixx", "Fiks", "Fex"], "wash": ["Wosh", "Washh", "Waash"], "clean": ["Cleen", "Clen", "Cleann"], "cook": ["Cok", "Coock", "Cookk"], "pour": ["Por", "Poure", "Paur"], "fill": ["Fil", "Filll", "Fyll"], "empty": ["Emty", "Emptyy", "Emtpy"], "tie": ["Tye", "Tii", "Tiee"], "untie": ["Unty", "Untye", "Untii"], "hide": ["Hydd", "Hid", "Hidee"], "find": ["Fyind", "Finnd", "Fynd"]};

  const GAME_DEFS = [
    ["quick-recall","⚡","Quick Recall","Rapid preparation focused on the 30 new Action Verbs.",["NEW VERBS", "ADAPTIVE"]],
    ["picture-action","🖼️","Picture Action","Identify each new Action Verb from a full uncropped image.",["VISUAL", "NEW TARGETS"]],
    ["listen-choose","🔊","Listen & Choose","Use British pronunciation and spoken action clues.",["LISTENING", "BRITISH"]],
    ["verb-meaning","🧠","Verb Meaning","Connect each Action Verb with its exact function.",["MEANING", "PRECISION"]],
    ["action-detective","🕵️","Action Detective","Infer the action from indirect evidence and context.",["INFERENCE", "REASONING"]],
    ["missing-letters","🔤","Missing Letters","Recover multiple missing letters from new Action Verbs.",["SPELLING", "TYPE"]],
    ["spelling-detector","✅","Spelling Detector","Identify exact spelling among plausible errors.",["SPELLING", "CHOICE"]],
    ["build-word","🧩","Build the Word","Construct complete Action Verbs from shuffled letters.",["SPELLING", "BUILD"]],
    ["verb-contrast","↔️","Verb Contrast","Distinguish close and opposite actions precisely.",["CONTRAST", "LOGIC"]],
    ["context-clues","🔎","Context Clues","Use controlled present contexts to deduce the missing base verb.",["CONTEXT", "INFERENCE"]],
    ["odd-one-out","🧠","Odd One Out","Classify actions and find the verb that does not belong.",["CLASSIFICATION", "ELIMINATION"]],
    ...
    ["practice-mistakes","🛠️","Practice My Mistakes","Target actions flagged by the Academic Record.",["NEEDS REVIEW", "PERSONALISED"]],
    ["mastery-challenge","👑","Mastery Challenge","80% new Action Verbs, 20% cumulative retrieval, no Gem Help.",["FINAL", "NO HELP"]]
  ...
  function updateHud(){
    ...
    $('heroName').textContent=profile?.name||'Hero';$('heroRank').textContent=`Action Pathfinder · ${TIER_NAMES[tier()]}`;
  ...
  function unlockArrivalCompanion(){/* Theme 09 shows silhouettes; the first companion unlocks after this Theme is mastered. */}
  ...
  function categoryQuestion(t=tier()){
    const pools={vertical:['Climb'], 'low-movement':['Crawl'], impact:['Kick','Hit'], 'vertical-object':['Lift','Drop'], 'control-object':['Hold'], contact:['Touch'], gesture:['Point','Wave'], direction:['Turn'], 'body-shape':['Bend','Stretch'], 'repeated-movement':['Shake'], 'sound-action':['Clap','Knock'], 'tool-action':['Cut'], 'material-action':['Fold'], 'change-state':['Break','Fix'], cleaning:['Wash','Clean'], 'food-preparation':['Cook'], 'liquid-action':['Pour'], 'container-action':['Fill','Empty'], fastening:['Tie','Untie'], location:['Hide','Find']};
    ...
    if(t<2)return q(`Which Action Verb belongs to the category “${label}”?`,ans,uniqueOptions(ans,distractors),ans,`Think about the category “${label}”.`,`Key feature: ${target(ans)?.trait||label}.`,'classification');
    return q(`Choose the Action Verb that belongs to “${label}” while the other options do not.`,ans,uniqueOptions(ans,distractors),ans,'Classify every option before choosing.',`The target’s key feature is: ${target(ans)?.trait||label}.`,'classification');
  }
  const PROPERTY_BANK=[
    ["Which verb means moving upwards using your hands and feet or steps?","Climb"],
    ["Which verb means moving with your body close to the ground, often on hands and knees?","Crawl"],
    ["Which verb means striking or sending something with your foot?","Kick"],
    ["Which verb means making forceful contact with a hand, tool or object?","Hit"],
    ["Which verb means moving an object upwards from a lower position?","Lift"],
    ["Which verb means releasing something so it falls?","Drop"],
    ["Which verb means keeping something in your hand or arms without letting it fall?","Hold"],
    ["Which verb means making direct contact with a finger or hand?","Touch"],
    ["Which verb means directing a finger towards a person, place or thing?","Point"],
    ["Which verb means rotating or facing another direction?","Turn"],
    ["Which verb means making the body or an object less straight?","Bend"],
    ["Which verb means extending the body, arms or legs?","Stretch"],
    ["Which verb means moving something quickly backwards and forwards?","Shake"],
    ["Which verb means moving a hand from side to side as a greeting?","Wave"],
    ["Which verb means bringing both hands together to make a sound?","Clap"],
    ["Which verb means hitting a door or surface to make a signal?","Knock"],
    ["Which verb means dividing something with a sharp tool?","Cut"],
    ["Which verb means bending material so one part lies over another?","Fold"],
    ["Which verb means damaging something so it separates or stops working?","Break"],
    ["Which verb means repairing something so it works again?","Fix"],
    ["Which verb means using water, often with soap, to remove dirt?","Wash"],
    ["Which verb means removing dirt or mess in a general way?","Clean"],
    ["Which verb means preparing food using heat?","Cook"],
    ["Which verb means making liquid flow from one container?","Pour"],
    ["Which verb means making a container full?","Fill"],
    ["Which verb means removing everything from a container?","Empty"],
    ["Which verb means fastening something with string, rope or a knot?","Tie"],
    ["Which verb means opening or removing a knot?","Untie"],
    ["Which verb means putting someone or something where it is difficult to see?","Hide"],
    ["Which verb means locating something you were looking for?","Find"]
  ];
  const CONTEXT_BANK=[
    ["I use both hands and feet to ___ the climbing wall.","Climb"],
    ["The baby moves on hands and knees, so the baby can ___.","Crawl"],
    ["I use my foot to ___ the football towards the goal.","Kick"],
    ["I use a bat to ___ the ball.","Hit"],
    ["I bend my knees and ___ the box from the floor.","Lift"],
    ["I open my hand and ___ the ball onto the grass.","Drop"],
    ["I ___ the cup carefully so it does not fall.","Hold"],
    ["I gently ___ the screen with one finger.","Touch"],
    ["I ___ at the correct answer on the board.","Point"],
    ["At the corner, I ___ left.","Turn"],
    ["I ___ my knees to pick up the pencil.","Bend"],
    ["Before exercise, I ___ my arms and legs.","Stretch"],
    ["I ___ the bottle before I use it.","Shake"],
    ["I see my friend across the street and ___.","Wave"],
    ["The audience is happy, so they ___.","Clap"],
    ["I ___ on the door before I enter.","Knock"],
    ["I use scissors to ___ the paper.","Cut"],
    ["I ___ the paper in half.","Fold"],
    ["Be careful not to ___ the glass.","Break"],
    ["The toy is broken, so I ___ it.","Fix"],
    ["Before eating, I ___ my hands with soap and water.","Wash"],
    ["I ___ my desk and remove the mess.","Clean"],
    ["I use a hot pan to ___ dinner.","Cook"],
    ["I ___ water from the bottle into a glass.","Pour"],
    ["I ___ the bucket with water.","Fill"],
    ["After the game, I ___ the bag and take everything out.","Empty"],
    ["I ___ my shoes before running.","Tie"],
    ["At home, I ___ my shoes and take them off.","Untie"],
    ["In the game, I ___ behind the tree.","Hide"],
    ["I search the room and finally ___ the missing key.","Find"]
  ];
  const MASTER_BANK=[
    ["You move upwards on a wall using your hands and feet. Which verb is most precise?","Climb"],
    ["Your body stays close to the floor while you move on hands and knees. Which verb describes the movement?","Crawl"],
    ["A football player sends the ball towards the goal using one foot. Which verb describes the action?","Kick"],
    ["A tennis player makes forceful contact with the ball using a racket. Which verb is correct?","Hit"],
    ["The box starts on the floor and ends in your hands at waist height. Which verb describes the upward movement?","Lift"],
    ["Your hand opens and the object falls to the ground. Which verb describes what you do?","Drop"],
    ["You keep a glass in your hand without moving it or letting it fall. Which verb is most precise?","Hold"],
    ["Your finger makes contact with the button, rather than only showing where it is. Which verb is correct?","Touch"],
    ["You do not touch the map; you direct your finger towards one city. Which verb is correct?","Point"],
    ["You are facing north and then face east. Which verb describes the change?","Turn"],
    ["You make your knees less straight so your body moves lower. Which verb is correct?","Bend"],
    ["You extend both arms fully before exercise. Which verb describes the action?","Stretch"],
    ["You move a closed bottle quickly backwards and forwards several times. Which verb is correct?","Shake"],
    ["You move your hand from side to side because you see a friend. Which verb is correct?","Wave"],
    ["You bring both hands together repeatedly because a performance was excellent. Which verb is correct?","Clap"],
    ["You make a short sound on a door before entering. Which verb is correct?","Knock"],
    ["You use scissors and the paper becomes two separate pieces. Which verb describes the action?","Cut"],
    ["The paper remains one piece, but one half lies over the other. Which verb is correct?","Fold"],
    ["The toy stops working after it separates into pieces. Which verb describes the damage?","Break"],
    ["You repair the damaged toy so it works again. Which verb describes your action?","Fix"],
    ["You use soap and water on your hands. Which verb is more precise than the general verb clean?","Wash"],
    ["You remove dust and mess from a desk without necessarily using water. Which verb is most precise?","Clean"],
    ["You use heat to prepare vegetables for dinner. Which verb is correct?","Cook"],
    ["Liquid moves from a bottle into a glass. Which verb describes the flowing action?","Pour"],
    ["The container changes from not full to full. Which verb describes the result?","Fill"],
    ["You remove every object from a bag until nothing remains inside. Which verb is correct?","Empty"],
    ["You make a knot in your shoelaces. Which verb is correct?","Tie"],
    ["You open the knot in your shoelaces. Which verb is correct?","Untie"],
    ["You put the key behind a book so another person cannot see it. Which verb is correct?","Hide"],
    ["You search several places and finally locate the missing key. Which verb is correct?","Find"]
  ];
  const CUMULATIVE_BANK=[
    ["You use force to move a box away from your body. Which earlier verb contrasts with pull?","Push"],
    ["You keep a bag in your hands while moving it from one room to another. Which earlier verb is correct?","Carry"],
    ["You send a ball through the air using your hand. Which earlier verb contrasts with catch?","Throw"],
    ["You stop a moving ball with your hands. Which earlier verb is correct?","Catch"],
    ["You place a cup on the table and leave it there. Which earlier verb is more precise than carry?","Put"],
    ["You create a model from paper and glue. Which earlier verb is correct?","Make"],
    ["You direct your eyes towards a sign for a moment. Which earlier verb is correct?","Look"],
    ["You follow a film on a screen for a period of time. Which earlier verb is correct?","Watch"],
    ["You move quickly on foot. Which earlier verb is correct?","Run"],
    ["You move on foot at a normal pace. Which earlier verb is correct?","Walk"],
    ["You move something towards you using force. Which earlier verb is correct?","Pull"],
    ["You use your voice to say words. Which earlier verb is correct?","Speak"]
  ];
  ...
  function cumulativeQuestion(t=tier()){
    ...
    return q(x[0],ans,uniqueOptions(ans,ALL_VERB_WORDS),ans,'Retrieve the earlier verb and compare it with the new Action Verbs.',`Earlier meaning: ${target(ans)?.clue||target(ans)?.es||'Use cumulative knowledge.'}`,'cumulative');
  }
  ...
  function riddleQuestion(t=tier()){
    ...
    return q(`Action Detective: choose the base verb for this evidence: ${clue}.`,ans,uniqueOptions(ans,VERB_WORDS),ans,'Turn every detail into one precise action.',target(ans)?.clue||x[0],'riddle');
  }
  ...
  function generateQuestion(kind='mixed',forcedTier=tier()){
    ...
    if(kind==='spelling'){const pool=TARGETS.filter(t=>t.word.length>=3),item=pool[Math.floor(Math.random()*pool.length)];return q('Choose the correctly spelled Action Verb.',item.word,spellingOptions(item.word),item.word,'Compare every letter carefully.',`Spelling rhythm: ${item.syllables}.`,'spelling',{explanation:`${item.word} is the correct spelling.`});}
  ...
  function startGame(id){
    ...
    const dispatch={
      ...
      'action-detective':()=>startStandard(game,'riddle',8),
      ...
      'action-mine':()=>startGoldMiner(game),
      'action-rush':()=>startVerbRush(game),
  ...
  function startOddOneOut(game){
    const sets=[
      [["Climb", "Crawl", "Turn", "Cook"],"Cook","The other three primarily describe body movement or direction."],
      [["Kick", "Hit", "Clap", "Find"],"Find","The other three can create a clear physical impact or sound."],
      [["Lift", "Drop", "Hold", "Sing"],"Sing","The other three involve controlling an object."],
      [["Touch", "Point", "Wave", "Wash"],"Wash","The other three are commonly hand gestures or contact actions."],
      [["Bend", "Stretch", "Turn", "Pour"],"Pour","The other three change body or object direction/shape."],
      [["Cut", "Fold", "Break", "Climb"],"Climb","The other three change the condition or shape of material."],
      [["Break", "Fix", "Wash", "Clean"],"Wash","Break and fix are opposite states; clean is also a result-changing action, while wash specifically focuses on water."],
      [["Fill", "Empty", "Pour", "Wave"],"Wave","The other three are connected with containers or liquid."],
      [["Tie", "Untie", "Hide", "Clap"],"Clap","The other three can change whether an object is secured or visible."],
      [["Hide", "Find", "Look", "Point"],"Point","Hide, find and look are connected with seeing or locating; point is a directional gesture."]
    ];
  ...
  function openGemHelp(){
    ...
    const options=[
      ...
      ['guide',20,'VOCABULARY GUIDE','Pause and review all 30 new Action Verbs, images, translations and pronunciation.'],
    ...
    ].filter(x=>!(x[0]==='fifty'&&(session.help5050||currentGame?.id==='action-mine')));
  ...
  function startPracticeMistakes(game){
    ...
    if(!keys.length&&PREVIEW){state.needsReview={stretch:3,pour:2,untie:2};keys=['stretch','pour','untie'];toast('Teacher Preview created sample Needs Review verbs.');}
  ...
  function buildMasterySet(){
    ...
    shuffle(TARGETS.filter(t=>t.word.length>=4)).slice(0,2).forEach(t=>add(q(`Type the correctly spelled Action Verb for “${t.es}”.`,t.word,[],t.word,'No hints are available in Mastery.',`Recall ${t.syllables}.`,'spelling'),'type'));
    // Three unique cumulative questions (20%) from Theme 08.
    shuffle(CUMULATIVE_BANK).slice(0,3).forEach((x,i)=>{
      const ans=x[1],prior=q(x[0],ans,uniqueOptions(ans,ALL_VERB_WORDS),ans,'Retrieve the earlier verb and compare it with the new Action Verbs.',target(ans)?.clue||'Use cumulative knowledge.','cumulative');
  ...
  function finishMastery(){
    ...
    if(score>=80){state.status=label;world2.themeComplete[CFG.themeIndex]=true;world2.themePending[CFG.themeIndex]=false;world2.themeIndex=Math.max(Number(world2.themeIndex)||0,CFG.themeIndex+1);world2.mastery=world2.mastery||{};world2.mastery[THEME_ID]=Math.max(Number(world2.mastery[THEME_ID])||0,score);world2.completed[CFG.themeIndex]=[...new Set(state.completedGames)];reward=score===100?{xp:1000,gems:100,gold:300}:score>=90?{xp:750,gems:65,gold:220}:{xp:550,gems:40,gold:160};addEconomy(reward);registerWeekly();if(score===100&&!state.badges.includes('Elite Action Scholar · Theme 09'))state.badges.push('Elite Action Scholar · Theme 09');}
