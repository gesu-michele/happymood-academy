(() => {
  ...
  const CFG = Object.assign({
    forceTeacher: false,
    assetRoot: '../../assets/world2/high-frequency-verbs/words/',
    audioRoot: '../../assets/world2/high-frequency-verbs/audio/',
  ...
  const THEME_ID = 'high-frequency-verbs';
  const THEME_KEY = 'lexiconia.theme10.highFrequencyVerbs.v1';
  ...
  const VERB_WORDS = ["Go", "Come", "Start", "Stop", "Wait", "Follow", "Enter", "Leave", "Arrive", "Return", "Cross", "Move", "Stay", "Bring", "Send", "Choose", "Show", "Use", "Help", "Work", "Learn", "Study", "Teach", "Ask", "Answer", "Call", "Smile", "Laugh", "Cry", "Think"];
  const PREVIOUS_VERB_WORDS = ["Eat", "Drink", "Sleep", "Walk", "Run", "Jump", "Sit", "Stand", "Read", "Write", "Speak", "Listen", "Look", "Watch", "Open", "Close", "Take", "Give", "Put", "Make", "Play", "Draw", "Sing", "Dance", "Swim", "Throw", "Catch", "Push", "Pull", "Carry", "Climb", "Crawl", "Kick", "Hit", "Lift", "Drop", "Hold", "Touch", "Point", "Turn", "Bend", "Stretch", "Shake", "Wave", "Clap", "Knock", "Cut", "Fold", "Break", "Fix", "Wash", "Clean", "Cook", "Pour", "Fill", "Empty", "Tie", "Untie", "Hide", "Find"];
  const ALL_VERB_WORDS = [...VERB_WORDS,...PREVIOUS_VERB_WORDS];
  const TIER_NAMES = ['FOUNDATION','EXPLORER','CHALLENGER','MASTER'];

  const TARGETS = [
    ["Go", "ir", "01-go.png", "01_go.png", "/ɡəʊ/", "go", "direction-perspective", "Move from your current place to another place.", "movement away from the current point"],
    ["Come", "venir", "02-come.png", "02_come.png", "/kʌm/", "come", "direction-perspective", "Move towards the speaker, listener or a named destination.", "movement towards a reference point"],
    ["Start", "empezar", "03-start.png", "03_start.png", "/stɑːt/", "start", "phase-control", "Begin an action, activity, journey or process.", "beginning"],
    ["Stop", "parar / detenerse", "04-stop.png", "04_stop.png", "/stɒp/", "stop", "phase-control", "End or interrupt an action, activity or movement.", "ending or interruption"],
    ["Wait", "esperar", "05-wait.png", "05_wait.png", "/weɪt/", "wait", "timing", "Stay ready or delay an action until someone arrives or something happens.", "delayed action"],
    ["Follow", "seguir", "06-follow.png", "06_follow.png", "/ˈfɒləʊ/", "fol·low", "guidance", "Move behind someone or continue along the same route or instructions.", "same route or sequence"],
    ["Enter", "entrar", "07-enter.png", "07_enter.png", "/ˈentə/", "en·ter", "boundary", "Go into a place, room, building or area.", "movement inside"],
    ["Leave", "salir / dejar", "08-leave.png", "08_leave.png", "/liːv/", "leave", "boundary", "Go away from a place, stop being there, or let something remain behind.", "departure or separation"],
    ["Arrive", "llegar", "09-arrive.png", "09_arrive.png", "/əˈraɪv/", "ar·rive", "journey", "Reach a place at the end of a journey.", "reaching a destination"],
    ["Return", "regresar / devolver", "10-return.png", "10_return.png", "/rɪˈtɜːn/", "re·turn", "journey", "Go back to a place or give something back.", "back movement or giving back"],
    ["Cross", "cruzar", "11-cross.png", "11_cross.png", "/krɒs/", "cross", "boundary", "Move from one side of a road, river, room or area to the other.", "side-to-side passage"],
    ["Move", "mover / moverse", "12-move.png", "12_move.png", "/muːv/", "move", "movement-state", "Change position or make something change position.", "position change"],
    ["Stay", "quedarse", "13-stay.png", "13_stay.png", "/steɪ/", "stay", "movement-state", "Remain in the same place or condition instead of leaving.", "remaining"],
    ["Bring", "traer", "14-bring.png", "14_bring.png", "/brɪŋ/", "bring", "transfer", "Carry or take something towards the speaker or a destination.", "transfer towards a reference point"],
    ["Send", "enviar", "15-send.png", "15_send.png", "/send/", "send", "transfer", "Cause a message, object or person to go to another place or person.", "transfer away to a destination"],
    ["Choose", "elegir", "16-choose.png", "16_choose.png", "/tʃuːz/", "choose", "decision", "Decide which person, object or possibility you want.", "selection"],
    ["Show", "mostrar", "17-show.png", "17_show.png", "/ʃəʊ/", "show", "communication-visual", "Let another person see, notice or understand something.", "presenting information or an object"],
    ["Use", "usar", "18-use.png", "18_use.png", "/juːz/", "use", "function", "Do something with an object, tool, idea or method for a purpose.", "purposeful application"],
    ["Help", "ayudar", "19-help.png", "19_help.png", "/help/", "help", "support", "Make it easier for another person to do or understand something.", "assistance"],
    ["Work", "trabajar", "20-work.png", "20_work.png", "/wɜːk/", "work", "activity", "Do a job or task, or function correctly.", "productive activity or correct function"],
    ["Learn", "aprender", "21-learn.png", "21_learn.png", "/lɜːn/", "learn", "learning", "Gain knowledge or a skill through study, experience or teaching.", "receiving knowledge or skill"],
    ["Study", "estudiar", "22-study.png", "22_study.png", "/ˈstʌdi/", "stud·y", "learning", "Spend focused time learning about a subject or preparing for a task.", "focused learning"],
    ["Teach", "enseñar", "23-teach.png", "23_teach.png", "/tiːtʃ/", "teach", "learning", "Help another person gain knowledge or a skill.", "giving knowledge or skill"],
    ["Ask", "preguntar", "24-ask.png", "24_ask.png", "/ɑːsk/", "ask", "communication", "Say or write a question to obtain information, permission or help.", "question"],
    ["Answer", "responder", "25-answer.png", "25_answer.png", "/ˈɑːnsə/", "an·swer", "communication", "Respond to a question, request or situation.", "response"],
    ["Call", "llamar", "26-call.png", "26_call.png", "/kɔːl/", "call", "communication", "Contact someone by phone, say a person's name, or ask someone to come.", "contact or naming"],
    ["Smile", "sonreír", "27-smile.png", "27_smile.png", "/smaɪl/", "smile", "emotion", "Make a pleased or friendly expression by curving the mouth.", "quiet positive expression"],
    ["Laugh", "reír", "28-laugh.png", "28_laugh.png", "/lɑːf/", "laugh", "emotion", "Make sounds and facial movements because something is funny or enjoyable.", "audible amusement"],
    ["Cry", "llorar", "29-cry.png", "29_cry.png", "/kraɪ/", "cry", "emotion", "Produce tears because of sadness, pain or a strong feeling.", "tears and strong feeling"],
    ["Think", "pensar", "30-think.png", "30_think.png", "/θɪŋk/", "think", "cognition", "Use the mind to consider ideas, remember information or solve a problem.", "mental processing"]
  ...
  const PREVIOUS_TARGETS = [
    {id:1,word:"Eat",es:"comer",ipa:"",syllables:"eat",group:"previous",clue:"Put food into your mouth and swallow it.",trait:"food action",previous:true},
    {id:2,word:"Drink",es:"beber",ipa:"",syllables:"drink",group:"previous",clue:"Take liquid into your mouth and swallow it.",trait:"liquid action",previous:true},
    {id:3,word:"Sleep",es:"dormir",ipa:"",syllables:"sleep",group:"previous",clue:"Rest with your eyes closed, usually in bed.",trait:"rest",previous:true},
    {id:4,word:"Walk",es:"caminar",ipa:"",syllables:"walk",group:"previous",clue:"Move on foot at a normal pace.",trait:"steady movement",previous:true},
    {id:5,word:"Run",es:"correr",ipa:"",syllables:"run",group:"previous",clue:"Move quickly on foot.",trait:"fast movement",previous:true},
    {id:6,word:"Jump",es:"saltar",ipa:"",syllables:"jump",group:"previous",clue:"Push your body off the ground.",trait:"air movement",previous:true},
    {id:7,word:"Sit",es:"sentarse / estar sentado",ipa:"",syllables:"sit",group:"previous",clue:"Rest your body on a seat.",trait:"seated position",previous:true},
    {id:8,word:"Stand",es:"estar de pie / ponerse de pie",ipa:"",syllables:"stand",group:"previous",clue:"Be upright on your feet.",trait:"upright position",previous:true},
    {id:9,word:"Read",es:"leer",ipa:"",syllables:"read",group:"previous",clue:"Understand written words.",trait:"written meaning",previous:true},
    {id:10,word:"Write",es:"escribir",ipa:"",syllables:"write",group:"previous",clue:"Make letters or words.",trait:"written production",previous:true},
    {id:11,word:"Speak",es:"hablar",ipa:"",syllables:"speak",group:"previous",clue:"Use your voice to say words.",trait:"voice",previous:true},
    {id:12,word:"Listen",es:"escuchar",ipa:"",syllables:"listen",group:"previous",clue:"Pay attention to sounds.",trait:"hearing attention",previous:true},
    {id:13,word:"Look",es:"mirar",ipa:"",syllables:"look",group:"previous",clue:"Direct your eyes towards something.",trait:"directed eyes",previous:true},
    {id:14,word:"Watch",es:"mirar / ver",ipa:"",syllables:"watch",group:"previous",clue:"Look at something for a period of time.",trait:"continued viewing",previous:true},
    {id:15,word:"Open",es:"abrir",ipa:"",syllables:"open",group:"previous",clue:"Make access possible.",trait:"access",previous:true},
    {id:16,word:"Close",es:"cerrar",ipa:"",syllables:"close",group:"previous",clue:"Shut something.",trait:"shut",previous:true},
    {id:17,word:"Take",es:"tomar / coger",ipa:"",syllables:"take",group:"previous",clue:"Move something into your hand or away with you.",trait:"towards receiver",previous:true},
    {id:18,word:"Give",es:"dar",ipa:"",syllables:"give",group:"previous",clue:"Move something to another person.",trait:"towards another person",previous:true},
    {id:19,word:"Put",es:"poner / colocar",ipa:"",syllables:"put",group:"previous",clue:"Place an object in a position.",trait:"placement",previous:true},
    {id:20,word:"Make",es:"hacer / crear",ipa:"",syllables:"make",group:"previous",clue:"Create or produce something.",trait:"creation",previous:true},
    {id:21,word:"Play",es:"jugar / tocar",ipa:"",syllables:"play",group:"previous",clue:"Take part in a game or use an instrument.",trait:"game or music",previous:true},
    {id:22,word:"Draw",es:"dibujar",ipa:"",syllables:"draw",group:"previous",clue:"Make a picture.",trait:"picture",previous:true},
    {id:23,word:"Sing",es:"cantar",ipa:"",syllables:"sing",group:"previous",clue:"Make musical sounds with your voice.",trait:"musical voice",previous:true},
    {id:24,word:"Dance",es:"bailar",ipa:"",syllables:"dance",group:"previous",clue:"Move rhythmically to music.",trait:"rhythm",previous:true},
    {id:25,word:"Swim",es:"nadar",ipa:"",syllables:"swim",group:"previous",clue:"Move through water.",trait:"water movement",previous:true},
    {id:26,word:"Throw",es:"lanzar",ipa:"",syllables:"throw",group:"previous",clue:"Send an object away through the air.",trait:"away through air",previous:true},
    {id:27,word:"Catch",es:"atrapar",ipa:"",syllables:"catch",group:"previous",clue:"Stop and hold a moving object.",trait:"towards hands",previous:true},
    {id:28,word:"Push",es:"empujar",ipa:"",syllables:"push",group:"previous",clue:"Move something away with force.",trait:"away",previous:true},
    {id:29,word:"Pull",es:"jalar / tirar de",ipa:"",syllables:"pull",group:"previous",clue:"Move something towards you with force.",trait:"towards",previous:true},
    {id:30,word:"Carry",es:"llevar / cargar",ipa:"",syllables:"carry",group:"previous",clue:"Hold something while moving it.",trait:"transport",previous:true},
    {id:31,word:"Climb",es:"escalar / subir",ipa:"",syllables:"climb",group:"previous",clue:"Move upwards using your hands and feet, steps or a surface.",trait:"upward movement",previous:true},
    {id:32,word:"Crawl",es:"gatear / arrastrarse",ipa:"",syllables:"crawl",group:"previous",clue:"Move slowly with your body close to the ground.",trait:"low body movement",previous:true},
    {id:33,word:"Kick",es:"patear",ipa:"",syllables:"kick",group:"previous",clue:"Strike or send something with your foot.",trait:"foot action",previous:true},
    {id:34,word:"Hit",es:"golpear",ipa:"",syllables:"hit",group:"previous",clue:"Touch something forcefully with your hand, a tool or another object.",trait:"forceful contact",previous:true},
    {id:35,word:"Lift",es:"levantar",ipa:"",syllables:"lift",group:"previous",clue:"Move an object upwards from a lower position.",trait:"upward object movement",previous:true},
    {id:36,word:"Drop",es:"dejar caer",ipa:"",syllables:"drop",group:"previous",clue:"Let something fall from your hand or a higher position.",trait:"downward release",previous:true},
    {id:37,word:"Hold",es:"sostener",ipa:"",syllables:"hold",group:"previous",clue:"Keep something in your hand or arms without letting it fall.",trait:"continued control",previous:true},
    {id:38,word:"Touch",es:"tocar",ipa:"",syllables:"touch",group:"previous",clue:"Put your hand, finger or body on something.",trait:"direct contact",previous:true},
    {id:39,word:"Point",es:"señalar",ipa:"",syllables:"point",group:"previous",clue:"Direct a finger or object towards a person, place or thing.",trait:"directed gesture",previous:true},
    {id:40,word:"Turn",es:"girar",ipa:"",syllables:"turn",group:"previous",clue:"Move or rotate so you face or point in another direction.",trait:"change of direction",previous:true},
    {id:41,word:"Bend",es:"doblar / inclinar",ipa:"",syllables:"bend",group:"previous",clue:"Move your body or an object so it is no longer straight.",trait:"curved position",previous:true},
    {id:42,word:"Stretch",es:"estirar",ipa:"",syllables:"stretch",group:"previous",clue:"Extend your body, arms or legs.",trait:"extended position",previous:true},
    {id:43,word:"Shake",es:"sacudir",ipa:"",syllables:"shake",group:"previous",clue:"Move something quickly backwards and forwards or up and down.",trait:"repeated movement",previous:true},
    {id:44,word:"Wave",es:"saludar con la mano / agitar",ipa:"",syllables:"wave",group:"previous",clue:"Move your hand from side to side to greet or attract attention.",trait:"side-to-side greeting",previous:true},
    {id:45,word:"Clap",es:"aplaudir",ipa:"",syllables:"clap",group:"previous",clue:"Bring your hands together repeatedly to make a sound.",trait:"hands making sound",previous:true},
    {id:46,word:"Knock",es:"tocar / golpear una puerta",ipa:"",syllables:"knock",group:"previous",clue:"Hit a door or surface to make a signal.",trait:"signal by impact",previous:true},
    {id:47,word:"Cut",es:"cortar",ipa:"",syllables:"cut",group:"previous",clue:"Use a sharp tool to divide or open something.",trait:"sharp-tool division",previous:true},
    {id:48,word:"Fold",es:"doblar",ipa:"",syllables:"fold",group:"previous",clue:"Bend material so one part lies over another.",trait:"layered material",previous:true},
    {id:49,word:"Break",es:"romper",ipa:"",syllables:"break",group:"previous",clue:"Damage something so it separates or no longer works.",trait:"damage",previous:true},
    {id:50,word:"Fix",es:"arreglar",ipa:"",syllables:"fix",group:"previous",clue:"Repair something so it works correctly again.",trait:"repair",previous:true},
    {id:51,word:"Wash",es:"lavar",ipa:"",syllables:"wash",group:"previous",clue:"Use water, often with soap, to remove dirt.",trait:"water cleaning",previous:true},
    {id:52,word:"Clean",es:"limpiar",ipa:"",syllables:"clean",group:"previous",clue:"Remove dirt or mess in a general way.",trait:"general cleaning",previous:true},
    {id:53,word:"Cook",es:"cocinar",ipa:"",syllables:"cook",group:"previous",clue:"Prepare food using heat.",trait:"food with heat",previous:true},
    {id:54,word:"Pour",es:"verter / servir líquido",ipa:"",syllables:"pour",group:"previous",clue:"Make liquid flow from one container.",trait:"flowing liquid",previous:true},
    {id:55,word:"Fill",es:"llenar",ipa:"",syllables:"fill",group:"previous",clue:"Make a container full.",trait:"making full",previous:true},
    {id:56,word:"Empty",es:"vaciar",ipa:"",syllables:"empty",group:"previous",clue:"Remove everything from a container.",trait:"making empty",previous:true},
    {id:57,word:"Tie",es:"atar",ipa:"",syllables:"tie",group:"previous",clue:"Fasten things using string, rope or a knot.",trait:"fastening",previous:true},
    {id:58,word:"Untie",es:"desatar",ipa:"",syllables:"untie",group:"previous",clue:"Open or remove a knot.",trait:"removing a knot",previous:true},
    {id:59,word:"Hide",es:"esconder",ipa:"",syllables:"hide",group:"previous",clue:"Put something where it cannot easily be seen.",trait:"concealment",previous:true},
    {id:60,word:"Find",es:"encontrar",ipa:"",syllables:"find",group:"previous",clue:"Locate something you were looking for.",trait:"successful search",previous:true}
  ];
  const ALL_TARGETS = [...TARGETS,...PREVIOUS_TARGETS];
  const TARGET_BY_WORD = Object.fromEntries(ALL_TARGETS.map(t=>[t.word.toLowerCase(),t]));
  const CATEGORY_LABELS = {"direction-perspective": "Movement and perspective", "phase-control": "Beginning and ending", "timing": "Timing and delay", "guidance": "Routes and guidance", "boundary": "Entering, leaving and crossing", "journey": "Journey completion and return", "movement-state": "Moving and remaining", "transfer": "Sending and bringing", "decision": "Choosing and decisions", "communication-visual": "Showing information", "function": "Using things for a purpose", "support": "Helping and support", "activity": "Work and tasks", "learning": "Learning and teaching", "communication": "Questions, answers and contact", "emotion": "Visible emotions", "cognition": "Thinking and mental action"};

  const KNOWLEDGE = [
    {fact:"Go usually describes movement away from the speaker; come describes movement towards the speaker or destination.",es:"Go suele describir movimiento que se aleja del hablante; come describe movimiento hacia el hablante o destino.",answer:"Come",icon:"↔️"},
    {fact:"Start begins an action or process; stop ends or interrupts it.",es:"Start inicia una acción o proceso; stop lo termina o interrumpe.",answer:"Stop",icon:"▶️⏹️"},
    {fact:"Wait delays action until something happens; stay means remain in a place or state.",es:"Wait retrasa una acción hasta que algo ocurre; stay significa permanecer en un lugar o estado.",answer:"Wait",icon:"⏳"},
    {fact:"Follow means continue behind someone or along the same route.",es:"Follow significa continuar detrás de alguien o por la misma ruta.",answer:"Follow",icon:"🧭"},
    {fact:"Enter moves inside a place; leave moves away from it.",es:"Enter mueve hacia dentro de un lugar; leave se aleja de él.",answer:"Enter",icon:"🚪"},
    {fact:"Arrive means reach a destination; return means go back to a previous place.",es:"Arrive significa llegar a un destino; return significa volver a un lugar anterior.",answer:"Return",icon:"🛬↩️"},
    {fact:"Cross moves from one side to the other, while move is the broader change of position.",es:"Cross mueve de un lado al otro, mientras move es el cambio general de posición.",answer:"Cross",icon:"🚸"},
    {fact:"Bring moves something towards the speaker or destination; take usually moves it away with the person.",es:"Bring mueve algo hacia el hablante o destino; take normalmente lo lleva en dirección contraria con la persona.",answer:"Bring",icon:"📦"},
    {fact:"Send causes a message or object to go to another person or place.",es:"Send hace que un mensaje u objeto vaya a otra persona o lugar.",answer:"Send",icon:"📨"},
    {fact:"Choose is the decision; use is what you do with the selected thing for a purpose.",es:"Choose es la decisión; use es lo que haces con lo elegido para un propósito.",answer:"Choose",icon:"✅"},
    {fact:"Show lets another person see or understand something; look is the action of directing your own eyes.",es:"Show permite que otra persona vea o comprenda algo; look es dirigir tus propios ojos.",answer:"Show",icon:"👀"},
    {fact:"Learn means gain knowledge; teach means help another person gain it.",es:"Learn significa adquirir conocimiento; teach significa ayudar a otra persona a adquirirlo.",answer:"Teach",icon:"🎓"},
    {fact:"Study is focused learning; work is a job or productive task.",es:"Study es aprendizaje enfocado; work es un trabajo o tarea productiva.",answer:"Study",icon:"📚"},
    {fact:"Ask produces a question; answer responds to it.",es:"Ask produce una pregunta; answer responde a ella.",answer:"Answer",icon:"❓💬"},
    {fact:"A smile is usually a quiet facial expression; a laugh normally includes sound.",es:"Smile suele ser una expresión facial silenciosa; laugh normalmente incluye sonido.",answer:"Laugh",icon:"😊😂"},
    {fact:"Cry commonly includes tears; think is an invisible mental action.",es:"Cry suele incluir lágrimas; think es una acción mental invisible.",answer:"Think",icon:"💭"}
  ];
  ...
  function updateHud(){
    ...
    $('heroName').textContent=profile?.name||'Hero';$('heroRank').textContent=`Verb Voyager · ${TIER_NAMES[tier()]}`;
  ...
  function unlockArrivalCompanion(){/* Theme 10 shows silhouettes; the first companion unlocks after this Theme is mastered. */}
  ...
  function categoryQuestion(t=tier()){
    const pools={"direction-perspective": ["Go", "Come"], "phase-control": ["Start", "Stop"], "timing": ["Wait"], "guidance": ["Follow"], "boundary": ["Enter", "Leave", "Cross"], "journey": ["Arrive", "Return"], "movement-state": ["Move", "Stay"], "transfer": ["Bring", "Send"], "decision": ["Choose"], "communication-visual": ["Show"], "function": ["Use"], "support": ["Help"], "activity": ["Work"], "learning": ["Learn", "Study", "Teach"], "communication": ["Ask", "Answer", "Call"], "emotion": ["Smile", "Laugh", "Cry"], "cognition": ["Think"]};
    ...
    if(t<2)return q(`Which High-Frequency Verb belongs to the category “${label}”?`,ans,uniqueOptions(ans,distractors),ans,`Think about the category “${label}”.`,`Key feature: ${target(ans)?.trait||label}.`,'classification');
  ...
  const PROPERTY_BANK=[["Which verb means moving from your current place to another place?", "Go"], ["Which verb means moving towards the speaker or a named destination?", "Come"], ["Which verb means beginning an action, activity or process?", "Start"], ["Which verb means ending or interrupting an action or movement?", "Stop"], ["Which verb means delaying action until someone arrives or something happens?", "Wait"], ["Which verb means moving behind someone or along the same route?", "Follow"], ["Which verb means going into a place?", "Enter"], ["Which verb means going away from a place or stopping being there?", "Leave"], ["Which verb means reaching a destination at the end of a journey?", "Arrive"], ["Which verb means going back to a place or giving something back?", "Return"], ["Which verb means moving from one side to the other?", "Cross"], ["Which verb means changing position or making something change position?", "Move"], ["Which verb means remaining in the same place instead of leaving?", "Stay"], ["Which verb means carrying something towards the speaker or destination?", "Bring"], ["Which verb means causing a message or object to go to another person or place?", "Send"], ["Which verb means deciding which option you want?", "Choose"], ["Which verb means letting another person see or understand something?", "Show"], ["Which verb means doing something with a tool or object for a purpose?", "Use"], ["Which verb means making a task easier for another person?", "Help"], ["Which verb means doing a job or productive task?", "Work"], ["Which verb means gaining knowledge or a skill?", "Learn"], ["Which verb means spending focused time learning about a subject?", "Study"], ["Which verb means helping another person gain knowledge or a skill?", "Teach"], ["Which verb means producing a question to obtain information?", "Ask"], ["Which verb means responding to a question or request?", "Answer"], ["Which verb means contacting someone by phone or saying their name?", "Call"], ["Which verb means making a friendly expression by curving the mouth?", "Smile"], ["Which verb means making sounds because something is funny?", "Laugh"], ["Which verb means producing tears because of sadness or pain?", "Cry"], ["Which verb means using your mind to consider ideas or solve a problem?", "Think"]];
  const CONTEXT_BANK=[["I ___ to school after breakfast.", "Go"], ["Please ___ here and sit next to me.", "Come"], ["The lesson can ___ now.", "Start"], ["The red light means ___.", "Stop"], ["I ___ at the bus stop until the bus arrives.", "Wait"], ["The guide walks ahead and we ___ her.", "Follow"], ["I open the door and ___ the classroom.", "Enter"], ["At the end of class, I ___ the room.", "Leave"], ["After the long journey, we finally ___ at the hotel.", "Arrive"], ["I borrow the book and later ___ it to the library.", "Return"], ["I look both ways before I ___ the road.", "Cross"], ["Please ___ the chair closer to the table.", "Move"], ["It is raining, so we ___ inside.", "Stay"], ["Please ___ your notebook to my desk.", "Bring"], ["I ___ a message to my friend.", "Send"], ["There are three games; I ___ the puzzle.", "Choose"], ["I ___ my drawing to the class.", "Show"], ["I ___ scissors to cut the paper.", "Use"], ["I ___ my friend carry the heavy box.", "Help"], ["My parents ___ at a hospital.", "Work"], ["I ___ a new word in English today.", "Learn"], ["I ___ for the science test after school.", "Study"], ["Teachers ___ students new skills.", "Teach"], ["I ___ a question when I need information.", "Ask"], ["I ___ when the teacher asks me a question.", "Answer"], ["I ___ my grandmother on the phone.", "Call"], ["I ___ when I see my friend.", "Smile"], ["I ___ when the joke is funny.", "Laugh"], ["I sometimes ___ when I feel very sad.", "Cry"], ["I stop and ___ before I choose an answer.", "Think"]];
  const MASTER_BANK=[["You are at home and travel to a different place. Which base verb describes the movement away from your current point?", "Go"], ["Your friend is far away and moves towards where you are standing. Which verb is most precise?", "Come"], ["Nothing is happening, then the activity begins. Which verb describes that change?", "Start"], ["The movement is happening, then it ends completely. Which verb describes the change?", "Stop"], ["You remain ready and do nothing until the train arrives. Which verb is most precise?", "Wait"], ["A leader walks ahead and you continue behind on the same route. Which verb is correct?", "Follow"], ["You are outside a building and pass through the door to the inside. Which verb is correct?", "Enter"], ["You are inside a room and go away from it. Which verb is correct?", "Leave"], ["A journey finishes when you reach the planned destination. Which verb describes that final moment?", "Arrive"], ["You go back to the place where you began. Which verb is correct?", "Return"], ["You begin on one side of a road and finish on the opposite side. Which verb is correct?", "Cross"], ["An object changes position but the direction is not the key idea. Which broad verb is correct?", "Move"], ["Everyone else leaves, but you remain in the same place. Which verb is correct?", "Stay"], ["The teacher asks for a book, and you carry it towards her. Which verb is more precise than take?", "Bring"], ["A message begins with you and travels to another person. Which verb describes the transfer?", "Send"], ["Several possibilities are available and you decide on one. Which verb is correct?", "Choose"], ["You let another person see your project. Which verb is more precise than look?", "Show"], ["You operate a tool because it has a particular purpose. Which verb is correct?", "Use"], ["Another person has difficulty, and your action makes the task easier. Which verb is correct?", "Help"], ["You complete a job or productive task. Which verb is correct?", "Work"], ["New knowledge becomes part of what you know. Which verb describes what happens to you?", "Learn"], ["You spend focused time with books and notes before an exam. Which verb is correct?", "Study"], ["You give knowledge or a skill to another learner. Which verb is correct?", "Teach"], ["You create a question because you need information. Which verb is correct?", "Ask"], ["Someone asks a question and you provide the response. Which verb is correct?", "Answer"], ["You contact a person using a telephone. Which verb is correct?", "Call"], ["Your mouth shows a friendly, pleased expression without sound. Which verb is correct?", "Smile"], ["Something is funny and you make sounds of amusement. Which verb is correct?", "Laugh"], ["A strong sad feeling produces tears. Which verb is correct?", "Cry"], ["You use your mind to compare possibilities before making a decision. Which verb is correct?", "Think"]];
  const CUMULATIVE_BANK=[["You move a heavy box away from your body using force. Which earlier verb is correct?", "Push"], ["You move the same box towards your body using force. Which earlier verb is correct?", "Pull"], ["You keep a bag in your hands while moving it to another room. Which earlier verb is correct?", "Carry"], ["You raise a box from the floor. Which Theme 09 verb is correct?", "Lift"], ["You place a cup on the table and leave it there. Which earlier verb is correct?", "Put"], ["You release the cup and let it fall. Which Theme 09 verb is correct?", "Drop"], ["You send a ball away through the air with your hand. Which earlier verb is correct?", "Throw"], ["You stop the moving ball with your hands. Which earlier verb is correct?", "Catch"], ["You direct your eyes towards a sign. Which earlier verb is correct?", "Look"], ["You keep your eyes on a moving scene for some time. Which earlier verb is correct?", "Watch"], ["You create a model from paper and glue. Which earlier verb is correct?", "Make"], ["You repair the model after it breaks. Which Theme 09 verb is correct?", "Fix"], ["You move quickly on foot. Which earlier verb is correct?", "Run"], ["You move on foot at a normal pace. Which earlier verb is correct?", "Walk"], ["You pay attention to sounds. Which earlier verb is correct?", "Listen"], ["You use your voice to say words. Which earlier verb is correct?", "Speak"], ["You fasten your shoelaces with a knot. Which Theme 09 verb is correct?", "Tie"], ["You locate the missing object after searching. Which Theme 09 verb is correct?", "Find"]];
  function propertyQuestion(t=tier()){
    ...
    return q(x[0],ans,options,ans,'Identify the action, direction, tool, result or purpose.',`Key meaning: ${target(ans)?.clue||'Use the full context.'}`,'reasoning');
  }
  function cumulativeQuestion(t=tier()){
    const x=CUMULATIVE_BANK[Math.floor(Math.random()*CUMULATIVE_BANK.length)],ans=x[1];
    return q(x[0],ans,uniqueOptions(ans,ALL_VERB_WORDS),ans,'Retrieve the earlier verb and connect it with the 90-verb cumulative bank.',`Earlier meaning: ${target(ans)?.clue||target(ans)?.es||'Use cumulative knowledge.'}`,'cumulative');
  }
  ...
  function riddleQuestion(t=tier()){
    ...
    return q(`Verb Detective: choose the base verb for this evidence: ${clue}.`,ans,uniqueOptions(ans,VERB_WORDS),ans,'Turn every detail into one precise action.',target(ans)?.clue||x[0],'riddle');
  }
  ...
  function generateQuestion(kind='mixed',forcedTier=tier()){
    ...
    if(kind==='spelling'){const pool=TARGETS.filter(t=>t.word.length>=3),item=pool[Math.floor(Math.random()*pool.length)];return q('Choose the correctly spelled High-Frequency Verb.',item.word,spellingOptions(item.word),item.word,'Compare every letter carefully.',`Spelling rhythm: ${item.syllables}.`,'spelling',{explanation:`${item.word} is the correct spelling.`});}
  ...
  function startPictureAction(game){
    createSession(game,8);currentStandardNext=()=>{const t=TARGETS[Math.floor(Math.random()*TARGETS.length)],qn=q('Which base verb is shown in the action image?',t.word,uniqueOptions(t.word,VERB_WORDS),t.word,'Study the body movement and the context.',`The Spanish meaning is “${t.es}”.`,'visual');newRoundQuestion(qn);
      prepareGameArea({kicker:'🖼️ PICTURE ACTION',prompt:qn.prompt,sub:'Images are shown complete with object-fit: contain.',html:`<div class="picture-focus"><div class="picture-panel">${imageMarkup(t)}</div><div class="picture-answer-grid">${qn.options.map(o=>`<button class="answer-btn" data-answer="${escapeHtml(o)}">${escapeHtml(o)}</button>`).join('')}</div></div>`});wireImageFallback();$$('.answer-btn',$('challengeArea')).forEach(b=>b.onclick=()=>answerMcq(b.dataset.answer,b));updateStats();};currentStandardNext();
  }
  ...
  function startOddOneOut(game){
    const sets=[[["Go", "Come", "Arrive", "Study"], "Study", "The other three are connected with movement or reaching a place."], [["Start", "Stop", "Wait", "Smile"], "Smile", "The other three control the timing or phase of an action."], [["Enter", "Leave", "Cross", "Laugh"], "Laugh", "The other three describe movement across a boundary or place."], [["Bring", "Send", "Show", "Cry"], "Cry", "The other three transfer or present something to another person or place."], [["Learn", "Study", "Teach", "Move"], "Move", "The other three are directly connected with learning and knowledge."], [["Ask", "Answer", "Call", "Stay"], "Stay", "The other three are communication actions."], [["Smile", "Laugh", "Cry", "Use"], "Use", "The other three express an emotion visibly or audibly."], [["Choose", "Think", "Use", "Arrive"], "Arrive", "The other three can be part of deciding and acting with a selected option."], [["Work", "Study", "Learn", "Call"], "Call", "The other three are productive or learning activities."], [["Go", "Come", "Stay", "Answer"], "Answer", "The other three describe movement or remaining in a place."]];
  ...
  function openGemHelp(){
    ...
    const options=[
      ...
      ['guide',20,'VOCABULARY GUIDE','Pause and review all 30 new High-Frequency Verbs, images, translations and pronunciation.'],
  ...
  function startPracticeMistakes(game){
    ...
    if(!keys.length&&PREVIEW){state.needsReview={follow:3,choose:2,answer:2};keys=['follow','choose','answer'];toast('Teacher Preview created sample Needs Review verbs.');}
  ...
  function buildMasterySet(){
    ...
    shuffle(TARGETS.filter(t=>t.word.length>=4)).slice(0,2).forEach(t=>add(q(`Type the correctly spelled High-Frequency Verb for “${t.es}”.`,t.word,[],t.word,'No hints are available in Mastery.',`Recall ${t.syllables}.`,'spelling'),'type'));
    // Three unique cumulative questions (20%) from Themes 08–09.
    shuffle(CUMULATIVE_BANK).slice(0,3).forEach((x,i)=>{
      const ans=x[1],prior=q(x[0],ans,uniqueOptions(ans,ALL_VERB_WORDS),ans,'Retrieve the earlier verb and connect it with the 90-verb cumulative bank.',target(ans)?.clue||'Use cumulative knowledge.','cumulative');
  ...
  function finishMastery(){
    ...
    if(score>=80){state.status=label;world2.themeComplete[CFG.themeIndex]=true;world2.themePending[CFG.themeIndex]=false;world2.themeIndex=Math.max(Number(world2.themeIndex)||0,CFG.themeIndex+1);world2.mastery=world2.mastery||{};world2.mastery[THEME_ID]=Math.max(Number(world2.mastery[THEME_ID])||0,score);world2.completed[CFG.themeIndex]=[...new Set(state.completedGames)];reward=score===100?{xp:1000,gems:100,gold:300}:score>=90?{xp:750,gems:65,gold:220}:{xp:550,gems:40,gold:160};addEconomy(reward);registerWeekly();if(score===100&&!state.badges.includes('Elite Verb Voyager · Theme 10'))state.badges.push('Elite Verb Voyager · Theme 10');}
  ...
  window.__LEXICONIA_THEME10_DEBUG__={TARGETS,PREVIOUS_TARGETS,ALL_TARGETS,GAME_DEFS,KNOWLEDGE,SPELLING_WRONG,generateQuestion,buildMasterySet,startGame,startPreteach,state:()=>state,preview:PREVIEW,config:CFG};
  function initEvents(){
